namespace SpriteKind {
    ...
    export const VisitingPlace = SpriteKind.create()
}
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Place, function (sprite, otherSprite) {
    info.changeScoreBy(1)
    otherSprite.setKind(SpriteKind.VisitingPlace)
})
...
let sprite_Village1: Sprite = null
let sprite_PLAYER: Sprite = null
let global_playerPosition: Sprite = null
let bol_enabledA = false
let bol_isVisitingPlaceAnimatin = false
